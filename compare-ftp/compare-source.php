...
<html>
<head>
    <title>Comparison Utility by Stackcoderz</title>
    <!-- Google Fonts -->
    <?php if(isConnected()) : ?>
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    ...
                    <div class="tools">
                        <a href="#" class="btn-delete-source-all" title="<?php echo DELETE_ALL_SOURCE_TITLE; ?>">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </a>
                        <a href="#" class="btn-download-all" title="<?php echo DOWNLOAD_ALL_TITLE; ?>">
                            <i class="fa fa-download" aria-hidden="true"></i>
                        </a>
                        <a href="#" class="btn-upload-all" title="<?php echo UPLOAD_ALL_TITLE; ?>">
                            <i class="fa fa-upload" aria-hidden="true"></i>
                        </a>
                        <a href="#" class="btn-delete-remote-all" title="<?php echo DELETE_ALL_REMOTE_TITLE; ?>">
                            <i class="fa fa-trash" aria-hidden="true"></i>
                        </a>
                    </div>
                    <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="tools-inner">
                                        <a href="#" class="btn-copy" title="<?php echo COPY_TITLE; ?>">
                                            <i class="fa fa-clipboard" aria-hidden="true"></i>
                                        </a>
                                        <?php if(checkPermission()) : ?>
                                        <a href="#" class="btn-delete-source"
                                           title="<?php echo DELETE_SOURCE_TITLE; ?>">
                                            <i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" class="btn-download" title="<?php echo DOWNLOAD_TITLE; ?>">
                                            <i class="fa fa-download" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" class="btn-upload" title="<?php echo UPLOAD_TITLE; ?>">
                                            <i class="fa fa-upload" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" class="btn-delete-remote"
                                           title="<?php echo DELETE_REMOTE_TITLE; ?>">
                                            <i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                                        <?php endif; ?>
                                    </div>
